...
parser.add_argument('--left_keypoints', default=10, type=int,
                    help='Number of keypoints left in PnP algorithm.')
...
parser.add_argument('--control_server', default='', type=str,
                    help='IP and port of the gabriel control server!')
...
parser.add_argument('--inp_dim', dest='inp_dim', type=str, default='416',
                    help='inpdim')
parser.add_argument('--conf', dest='confidence', type=float, default=0.01,
